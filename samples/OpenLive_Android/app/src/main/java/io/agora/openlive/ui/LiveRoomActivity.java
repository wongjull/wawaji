...
//                audienceUI(button1, button2, button3);
    ...
    public void start(View view){
        ...
        ButtonUp.setOnTouchListener(startListener);

        ButtonDown = (Button)findViewById(R.id.button_down);
        ButtonDown.setOnTouchListener(startListener);

        ButtonLeft = (Button)findViewById(R.id.button_left);
        ButtonLeft.setOnTouchListener(startListener);

        ButtonRight = (Button)findViewById(R.id.button_right);
        ButtonRight.setOnTouchListener(startListener);

        ButtonAction = (Button)findViewById(R.id.button_action);
        ButtonAction.setOnClickListener(startListener);
        Log.i("start","start Mechine");
        wawa.start();
    }
    ...
    public void back(View view){ wawa.back();}
    ...
    class ButtonListener implements View.OnClickListener, View.OnTouchListener {
        ...
        public void onClick(View v) {
            if(v.getId() == R.id.button_start){
                wawa.start();
                Log.i("test", "cansal button ---> start");
            }
        ...
        public boolean onTouch(View v, MotionEvent event) {
            if(v.getId() == R.id.button_left){
                ...
                if(event.getAction() == MotionEvent.ACTION_UP){
                    wawa.stop();
                    Log.i("start", "cansal button ---> up");
//                    return false;
//                mButton.setBackgroundResource(R.drawable.green);
                }
                if(event.getAction() == MotionEvent.ACTION_DOWN){
                    wawa.left();
                    Log.i("start", "cansal button ---> down");
//                mButton.setBackgroundResource(R.drawable.yellow);
            ...
            if(v.getId() == R.id.button_up){
                ...
                if(event.getAction() == MotionEvent.ACTION_UP){
                    wawa.stop();
                    Log.i("up", "cansal button ---> up");
//                mButton.setBackgroundResource(R.drawable.green);
                }
                if(event.getAction() == MotionEvent.ACTION_DOWN){
                    wawa.back();
                    Log.i("up", "cansal button ---> down");
//                mButton.setBackgroundResource(R.drawable.yellow);
                }
            }
